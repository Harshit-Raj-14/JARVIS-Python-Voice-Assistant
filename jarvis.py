...
def wishMe():  
    speak("Hello! This is Jarvis a virtual AI Assistant. May I know your name?")
    name= takeCommand().lower()

    hour = int(datetime.datetime.now().hour)
    if hour >= 0 and hour <= 3:
        speak("I am Your Personal assistant, Jarvis! version 0.1!")
        ...
        speak("Hello ,I am Your Personal assistant, Jarvis! version 0.1!")
    return name
...
def sendEmail(to, content):
    server= smtplib.SMTP('smtp.gmail.com', 587) #gmail we are going to use and port no. to send gmail Also, smtplib module helps to send mail
    server.ehlo()   #start process of sending email
    server.starttls()   #move to  asecure connection
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if 'wikipedia' in query:
        ...
        elif 'stop' in query or 'shut up' in query or 'go offline' in query or 'offline' in query or 'sleep' in query:
            speak('Alright Sir! Ping me up when you need me again')
            sys.exit(0)

        elif 'thank you' in query or 'appreciate' in query:
            speak("It's my duty to assist you anytime.")
            ...
            try:
                ...
                speak("Your message has been successfuly delivered.")
...
print("Hello I am your personal virtual Assistant Jarvis!")
